        ...
        <div class="col-md-8 col-md-offset" style="width:99%;">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="formCategoryAdd" class="form-horizontal" method="POST" action="/admin/member/group/search/category/add/{{ $group_id }}/send">
						{{ csrf_field() }}
						<center>
								...
								<div class="form-group" style="align:center;">
									<table border="1" width="95%">
										...
										<tr style="text-align:center;">
											<td><input type="text" name="category_name" value="" size="40" maxlength="{{ config('const.group_name_max_length') }}"></td>
