...
$(document).ready(function(){
	...
	$('#search').on('click', function(){
		search_win = window.open('/admin/member/melmaga/reserve/search/setting', 'convert_table', 'width=805, height=710');
		return false;
	});
	...
	submitAlert('formMelmagaMail', 'post', '{{ __('messages.dialog_alert_title') }}', '{{ __('messages.dialog_alert_msg') }}', '{{ __('messages.update_msg') }}', '{{ __('messages.cancel_msg') }}', {{ config('const.admin_default_ajax_timeout') }}, true);
