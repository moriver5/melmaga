                ...
                <div class="panel-body">
                    ...
                    <form id="formPasswordReset" class="form-horizontal" method="POST" action="/admin/forget">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" maxlength="{{ config('const.email_length') }}" placeholder="登録したメールアドレスを入力してください" required autofocus>
