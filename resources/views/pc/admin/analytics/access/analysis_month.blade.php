        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                ...
                <div class="panel-heading" style="font:normal 12px/120% 'メイリオ',sans-serif;text-align:center;">
					<b><a href="/admin/member/analytics/access/{{$prev_year}}/{{ $prev_month }}">PREV</a>&nbsp;&nbsp;|&nbsp;&nbsp;<b><a href="/admin/member/analytics/access/{{$year}}">{{ $year }}年</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/admin/member/analytics/access/{{$next_year}}/{{ $next_month }}">NEXT</a></b>
				</div>
							...
							@foreach($db_data as $day => $lines)
								<tr style="font:12px/120% 'メイリオ',sans-serif;">
									<td style="padding:3px;text-align:center;">
										<a href="/admin/member/analytics/access/{{ $year }}/{{ $month }}/{{ $day }}">{{ $day }}日</a>
									</td>
