...
<!--								<a href="{{ $link_url }}" class="btn btn-primary" target="_blank" id="lp_preview">&nbsp;&nbsp;プレビュー&nbsp;&nbsp;</a>-->
<!--								<a href="javascript:void(0)" class="btn btn-primary" id="lp_preview">&nbsp;&nbsp;プレビュー&nbsp;&nbsp;</a>-->
...
$(document).ready(function(){
	...
	$('#lp_preview').click(function () {
		if( $('#lp_div').hasClass('col-md-10') ){
			$.ajax({
				url:"/admin/member/lp/create/content/{{ $id }}/{{ $current_page }}/preview",
				type:'POST',
