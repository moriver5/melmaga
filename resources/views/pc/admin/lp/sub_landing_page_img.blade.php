        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default" style="font-size:12px;">
                ...
                <div class="panel-body">
                    <form id="formImageUpload" class="form-horizontal" method="POST" action="/admin/member/lp/list/subpage/content/img/{{ $id }}/{{ $page_name }}/upload">
                        {{ csrf_field() }}
            ...
            <div class="panel panel-default" style="font-size:12px;">
                ...
                <div class="panel-body">
					...
					<div style="color:black;font:bold 13px/130% 'メイリオ',sans-serif;">
						...
						<b>
							※ PDF/画像を使用する際には<br />
							&lt;img src="/[ページ名]/img/[image名]" alt="***" width="***" height="***" /&gt;<br />
							例）&lt;img src="/test/img/test.jpg" alt="test" width="100" height="50" /&gt;<br />
							<br />
							&lt;a href="/[ページ名]/img/[PDF名]"&gt;PDF&lt;/a&gt;<br />
							例）&lt;a href="/test/img/test.pdf"&gt;PDF&lt;/a&gt;
						</b>
					</div>
					</form>
                </div>
